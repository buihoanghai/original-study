---
type: manual
description: Task Contract template - use this format for all tasks
---

# Task Contract

## Type
Feature / Bug / Refactor / Tech-debt
...
Why this task exists. Link to issue/bug if any.
